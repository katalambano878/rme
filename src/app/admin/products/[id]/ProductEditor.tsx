    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button className="px-6 py-3 bg-rose-light0 hover:bg-navy text-white rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer">
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center space-x-2 px-6 py-4 font-semibold whitespace-nowrap transition-colors border-b-2 cursor-pointer ${
                  activeTab === tab.id
                    ? 'border-navy text-navy bg-rose-light'
          ...
          {activeTab === 'pricing' && (
            <div className="space-y-6 max-w-3xl">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-16 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-navy focus:border-rose-primary"
                      step="0.01"
                    />
                  </div>
                </div>
              ...
              <div className="p-4 bg-rose-light border border-rose-border rounded-lg">
                <p className="text-navy font-semibold mb-1">Discount Calculation</p>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-navy focus:border-rose-primary font-mono"
          ...
          {activeTab === 'variants' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <button className="px-4 py-2 bg-rose-light0 hover:bg-navy text-white rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {images.map((image, index) => (
                  <div key={index} className="relative group">
                    ...
                    {index === 0 && (
                      <span className="absolute top-2 left-2 bg-rose-light0 text-white px-2 py-1 rounded text-xs font-semibold whitespace-nowrap">
                        Primary
                      </span>
                    )}
                ...
                <button className="aspect-square border-2 border-dashed border-gray-300 rounded-xl hover:border-navy hover:bg-rose-light transition-colors flex flex-col items-center justify-center space-y-2 text-gray-600 hover:text-navy cursor-pointer">
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-r-lg focus:ring-2 focus:ring-navy focus:border-rose-primary"
                  />
                </div>
              </div>

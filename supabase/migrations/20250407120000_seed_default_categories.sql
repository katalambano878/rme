-- Default storefront categories (same list as src/lib/catalog-default-categories.ts).
-- Applied with migrations so Admin → Categories shows these rows without manual seed runs.
